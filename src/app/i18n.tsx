...
const dict = {
  ...
  es: {
    ...
    services: [
      { title: "Sports OS (Sistema Operativo)", desc: "Arquitectura de sistema operativo propietaria diseñada para centralizar datos de rendimiento, modelos de visión computacional y analítica predictiva para clubes y academias de élite." },
      { title: "Interfaces Deportivas Inteligentes", desc: "Entornos digitales de alta precisión y paneles de control táctico construidos para entrenadores, scouts y atletas en tiempo real." },
      ...
      { title: "Dron Cinemático", desc: "Grabación aérea de alta velocidad y seguimiento con drones. Capturamos ángulos impresionantes para análisis de rendimiento y publicidad deportiva." },
