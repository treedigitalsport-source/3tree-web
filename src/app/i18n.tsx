...
const dict = {
  en: {
    ...
    letsTalk: "Let's Talk",
    marquee2: ["Baseball", "Basketball", "Football", "Soccer", "Tennis", "Golf", "eSports", "MMA", "Swimming", "Track & Field"],
  ...
  es: {
    ...
    letsTalk: "Hablemos",
    marquee2: ["Béisbol", "Baloncesto", "Fútbol", "Fútbol Americano", "Tenis", "Golf", "eSports", "MMA", "Natación", "Atletismo"],
