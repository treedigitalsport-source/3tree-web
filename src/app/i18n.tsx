...
const dict = {
  en: {
    ...
    about: {
      ...
      pillars: [
        { title: "Markerless 3D Biomechanics", desc: "3D kinematic reconstruction at 240 fps using Kinebase Pro directly from standard video without physical markers or suits. Precise tracking of joint angles, rotational torque, and real-time injury prevention." },
        { title: "Sports OS Core & Data Engine", desc: "Proprietary sports intelligence architecture centralizing performance metrics, telemetry, and analytics databases for clubs, academies, and professional sports organizations." },
        { title: "Predictive Scouting & LLM Analytics", desc: "Eradicating human bias using custom language models and computer vision that transform subjective scouting notes into structured talent profiles and performance curves." },
        { title: "AI Agents & Automation", desc: "Bespoke AI agents and automated video processing pipelines that process data, distribute tactical footage, and optimize sports operations 24/7 with zero manual friction." }
      ],
  ...
  es: {
    ...
    scouting: "Base de Datos Analítica",
    whoDaresWins: "Who Dares Wins",
    ...
    services: [
      { title: "Sports OS Core", desc: "Arquitectura propietaria para centralizar rendimiento, visión computacional y analítica predictiva en clubes y academias de élite." },
      { title: "Interfaces Deportivas", desc: "Entornos digitales de alta precisión y paneles tácticos en tiempo real para entrenadores, scouts y atletas." },
      { title: "Automatización", desc: "Pipelines automáticos que optimizan flujos de trabajo, ahorran tiempo y eliminan el error humano en el scouting." },
      { title: "Implementación de IA", desc: "LLMs predictivos y visión por computadora integrados en tu ecosistema. Inteligencia artificial que realmente funciona." },
      { title: "Dron Cinemático", desc: "Grabación aérea de alta velocidad con drones. Ángulos impresionantes para análisis y publicidad deportiva." },
      { title: "Agentes de IA", desc: "Asistentes autónomos 24/7 a la medida de tu negocio. Automatizan tareas complejas y mejoran el engagement deportivo." },
    ],
    ...
    langToggle: "EN",
    project1Title: ["Gridiron", "AI"],
    project2Title: ["Analítica", "de Datos"],
    project3Title: ["Analítica", "Deportiva"],
    ...
    about: {
      title: "QUIÉNES SOMOS",
      subtitle: "3TREE DIGITAL SPORT IA · SPORTS INTELLIGENCE COMPANY",
      tagline: "Revolución Sport Tech · Tecnología, IA, Datos y Automatización Deportiva.",
      heroText1: "Con sede en Lutz, Florida, y una visión global, 3Tree Digital Sport IA es una compañía de Sports Intelligence enfocada en transformar la manera en que la tecnología, los datos y la Inteligencia Artificial se aplican al deporte. Diseñamos y desarrollamos sistemas inteligentes avanzados, aplicaciones móviles, agentes de IA, sistemas de automatización, soluciones de datos, tecnologías basadas en drones, branding deportivo y experiencias digitales para el ecosistema deportivo.",
