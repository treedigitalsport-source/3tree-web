...
export default function JournalHub() {
  ...
  useEffect(() => {
    ...
    async function fetchArticles() {
      ...
      // Bypassing Firebase for now to use local data perfectly
          ...
          <Link href={`/journal/${featuredNeil.slug || featuredNeil.id}`} className="block group hoverable w-full relative h-[60vh] md:h-[85vh] overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[#020617] z-0">
              ...
              <Image 
                ...
                alt={isEs ? featuredNeil.titleEs : featuredNeil.titleEn}
            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-between p-8 md:p-16 lg:p-24">
              ...
              <div className="max-w-5xl">
                ...
                <p className="font-mono text-xs md:text-sm uppercase tracking-[0.3em] text-brandOrange mb-6 flex items-center gap-4">
                  ...
                  {isEs ? featuredNeil.timeEs : featuredNeil.timeEn}
                ...
                <h2 className="font-display text-4xl md:text-6xl lg:text-[6rem] font-black uppercase leading-[0.9] text-white transition-colors duration-500">
                  ...
                  {isEs ? featuredNeil.titleEs : featuredNeil.titleEn}
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-between z-10">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <span className="font-mono text-[9px] font-bold uppercase tracking-widest pl-6 pr-5 py-2.5 bg-white/5 backdrop-blur-xl border-l-2 border-brandOrange text-white shadow-[0_4px_30px_rgba(0,0,0,0.5)] relative overflow-hidden flex items-center gap-2">
                    ...
                    {isEs ? (article.categoryEs || "Reporte") : (article.categoryEn || "Report")}
                ...
                <div>
                  ...
                  <div className="font-mono text-[9px] uppercase tracking-[0.2em] text-brandOrange mb-4 flex items-center gap-2">
                    ...
                    <Clock className="w-3 h-3" /> {isEs ? article.timeEs : article.timeEn}
                  ...
                  {article.author && (
                    ...
                    <p className="font-mono text-[10px] text-white/70 uppercase tracking-[0.2em] mt-3">
