...
export function SocialLinks({ className = "", iconSize = "w-4 h-4" }: { className?: string, iconSize?: string }) {
  return (
    <div className={`flex gap-3 flex-wrap ${className}`}>
      {/* Instagram */}
      <a href="https://instagram.com/3treedigital" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#E1306C] hover:text-white hover:border-[#E1306C] transition-all cursor-pointer text-white/50">
      ...
      {/* YouTube */}
      <a href="https://youtube.com/@3treedigital" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] transition-all cursor-pointer text-white/50">
      ...
      {/* Pinterest */}
      <a href="https://pinterest.com/3treedigital" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#E60023] hover:text-white hover:border-[#E60023] transition-all cursor-pointer text-white/50">
