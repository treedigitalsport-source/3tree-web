...
export function SocialLinks({ className = "", iconSize = "w-4 h-4" }: { className?: string, iconSize?: string }) {
  return (
    <div className={`flex gap-3 flex-wrap ${className}`}>
      ...
      {/* Rumble */}
      <a href="https://rumble.com/" target="_blank" rel="noopener noreferrer" aria-label="Rumble" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#85c742] hover:text-white hover:border-[#85c742] transition-all cursor-pointer text-white/50">
