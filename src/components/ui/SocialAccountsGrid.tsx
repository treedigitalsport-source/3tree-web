...
export function SocialAccountsGrid() {
  ...
  const accounts: SocialAccountItem[] = [
    ...
    },
    {
      ...
      color: "#FF0000",
      badge: isEs ? "Oficial" : "Official",
      category: isEs ? "Canal y Podcast Principal" : "Main Channel & Podcast",
      icon: (
    ...
    {
      name: "YouTube (Boxeo & Combate)",
      handle: "@ENTRE4CUERDAS",
      url: "https://www.youtube.com/@ENTRE4CUERDAS",
      color: "#10B981",
      badge: isEs ? "Entre 4 Cuerdas" : "Entre 4 Cuerdas",
      category: isEs ? "Canal de Deportes de Combate" : "Combat Sports Channel",
      icon: (
    ...
    },
    {
      name: "TikTok",
      handle: "@3TreeSportAI",
      url: "https://www.tiktok.com/@3TreeSportAI",
      color: "#00F2FE",
      badge: isEs ? "Oficial" : "Official",
      category: isEs ? "Video Viral & IA" : "Viral Video & AI",
