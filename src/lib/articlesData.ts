...
The digital transformation of sports has redefined what it means to understand the game. What once took weeks of manual charting is now processed in real time to influence tactical decisions in every inning.`
  },
  {
    ...
    author: "Ali Zapata",
    authorRoleEs: "Fundador de 3Tree Digital Sport IA | 26 años como Preparador Físico, Especialista en Sport Tech y Diplomado en Biomecánica",
    authorRoleEn: "Founder of 3Tree Digital Sport IA | 26 Years as Strength & Conditioning Coach, Sport Tech Specialist & Diploma in Biomechanics",
